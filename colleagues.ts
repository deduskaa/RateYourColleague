...
export const colleagues: Colleague[] = [
  {
    emojis: ['🦆', '😡', '🔵'],
    title: 'Donald Duck',
    description: `Donald's two dominant personality traits are his fiery temper and his upbeat attitude to life.`,
    rating: 5,
  },
  {
    emojis: [],
  ...
  {emojis: [], title: 'Huey Duck', description: 'Desc', rating: 5},
